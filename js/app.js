...
function llenarSelect() {
    for (let i = max; i >= min; i--) {// for de mayor a menor
...
//funcion filtra en base a la busqueda
...
function noResultado() {
    ...
    noResultado.textContent = 'No hay Resultado, intenta con otras opciones de busqueda';
